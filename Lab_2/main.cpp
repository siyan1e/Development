...
//    const QByteArray hash0_base64 = QByteArray("5G4Cz3vTd4wDGaj4wZe+/CmR6CAoCE//MQ3lNuLfxpI=");
...
//    satelliteProcess->start("C:/build-DebugProtect-Desktop_Qt_6_3_0_MSVC2019_64bit-Debug/debug/DebugProtect.exe", arguments);
...
//    qDebug() << "protectorStarted = " << protectorStarted;
    ...
    context->setContextProperty("modal", base.modal);
