...
--*/
{
    ...
    status = FltGetFileNameInformation(
        ...
        &NameInfo);
    UNICODE_STRING required_extension = RTL_CONSTANT_STRING(L"shumakov");
    if (!NT_SUCCESS(status))
    {
        ...
        unsigned char k[] = "z9zEgy9RxD6nyY2v";   
        uint8_t* key = (uint8_t*)k;
        uint8_t iv[] = { 0x5e, 0x34, 0x46, 0x6f, 0x42, 0x68, 0x28, 0xff, 0x5e, 0x55, 0x58, 0x49, 0x4f, 0x6e, 0x22, 0x21 };
